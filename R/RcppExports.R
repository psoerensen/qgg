...
sbayes_spa <- function(wy, ww, LDvalues, LDindices, b, lambda, yy, pi, gamma, vg, vb, ve, ssb_prior, sse_prior, nub, nue, updateB, updateE, updatePi, updateG, adjustE, n, nit, method, algo) {
    .Call(`_qgg_sbayes_spa`, wy, ww, LDvalues, LDindices, b, lambda, yy, pi, gamma, vg, vb, ve, ssb_prior, sse_prior, nub, nue, updateB, updateE, updatePi, updateG, adjustE, n, nit, method, algo)
}
