...
**qgg** provides an infrastructure for efficient processing of large-scale genetic and phenotypic data including:
* core functions for fitting linear mixed models
