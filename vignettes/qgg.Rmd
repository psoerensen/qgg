...
* **Data preparation**  
     ...
     + [Prepare phenotype and covariate data](http://psoerensen.github.io/qgg/articles/Prepare_Phenotype_Data_Starvation.html) $\mathbf{y, X}$  
  
     + [Prepare genotype data](http://psoerensen.github.io/qgg/articles/Prepare_Genotypes.html) $\mathbf{W}$  
