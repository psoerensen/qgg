...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(sbayes_spa(wy, ww, LDvalues, LDindices, b, lambda, yy, pi, gamma, vg, vb, ve, ssb_prior, sse_prior, nub, nue, updateB, updateE, updatePi, updateG, adjustE, n, nit, method, algo));
    return rcpp_result_gen;
END_RCPP
}
// sbayes_reg
