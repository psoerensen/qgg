...
// sbayes
std::vector<std::vector<double>> sbayes(double yy, std::vector<double>& wy, std::vector<double>& ww, std::vector<std::vector<double>>& LDvalues, std::vector<std::vector<int>>& LDindices, std::vector<double> b, std::vector<double> lambda, std::vector<bool> mask, std::vector<double> pi, std::vector<double> gamma, double vg, double vb, double ve, double ssb_prior, double ssg_prior, double sse_prior, double nub, double nug, double nue, bool updateB, bool updateG, bool updateE, bool updatePi, bool adjustE, int n, int nit, int nburn, int nthin, int method, int algo, int seed);
RcppExport SEXP _qgg_sbayes(SEXP yySEXP, SEXP wySEXP, SEXP wwSEXP, SEXP LDvaluesSEXP, SEXP LDindicesSEXP, SEXP bSEXP, SEXP lambdaSEXP, SEXP maskSEXP, SEXP piSEXP, SEXP gammaSEXP, SEXP vgSEXP, SEXP vbSEXP, SEXP veSEXP, SEXP ssb_priorSEXP, SEXP ssg_priorSEXP, SEXP sse_priorSEXP, SEXP nubSEXP, SEXP nugSEXP, SEXP nueSEXP, SEXP updateBSEXP, SEXP updateGSEXP, SEXP updateESEXP, SEXP updatePiSEXP, SEXP adjustESEXP, SEXP nSEXP, SEXP nitSEXP, SEXP nburnSEXP, SEXP nthinSEXP, SEXP methodSEXP, SEXP algoSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type seed(seedSEXP);
    rcpp_result_gen = Rcpp::wrap(sbayes(yy, wy, ww, LDvalues, LDindices, b, lambda, mask, pi, gamma, vg, vb, ve, ssb_prior, ssg_prior, sse_prior, nub, nug, nue, updateB, updateG, updateE, updatePi, adjustE, n, nit, nburn, nthin, method, algo, seed));
    return rcpp_result_gen;
END_RCPP
}
// sbayes_reg
...
// mtgrsbed_omp
std::vector<std::vector<double>> mtgrsbed_omp(std::string file, int n, const std::vector<int>& cls, const std::vector<double>& af, bool scale, const std::vector<std::vector<double>>& b, int nthreads);
...
// mtgrsbed_matrix_fast01
Rcpp::NumericMatrix mtgrsbed_matrix_fast01(std::string file, int n, const std::vector<int>& cls, const std::vector<double>& af, bool scale, Rcpp::NumericMatrix S, int nthreads);
RcppExport SEXP _qgg_mtgrsbed_matrix_fast01(SEXP fileSEXP, SEXP nSEXP, SEXP clsSEXP, SEXP afSEXP, SEXP scaleSEXP, SEXP SSEXP, SEXP nthreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type file(fileSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type S(SSEXP);
    Rcpp::traits::input_parameter< int >::type nthreads(nthreadsSEXP);
    rcpp_result_gen = Rcpp::wrap(mtgrsbed_matrix_fast01(file, n, cls, af, scale, S, nthreads));
    return rcpp_result_gen;
END_RCPP
}
// mvrnormARMA
